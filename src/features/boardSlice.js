const initialState = [
  {id: 0, contents: 'Emmanuel', visible: true, matched: true}, 
  {id: 1, contents: 'Emmanuel', visible: true, matched: true}, 
  {id: 2, contents: 'Gabriel', visible: true, matched: true}, 
  {id: 3, contents: 'Gabriel', visible: true, matched: true}, 
  {id: 4, contents: 'faith', visible: true, matched: true}, 
  {id: 5, contents: 'faith', visible: true, matched: true}, 
  {id: 6, contents: 'favour', visible: true, matched: true}, 
  {id: 7, contents: 'favour', visible: true, matched: true}, 
  {id: 8, contents: 'joshua', visible: true, matched: true}, 
  {id: 9, contents: 'joshua', visible: true, matched: true}, 
  {id: 10, contents: 'maureen', visible: true, matched: true}, 
  {id: 11, contents: 'maureen', visible: true, matched: true}, 
];
...
export const boardSelector = state => state.board.map(card=>({id: card.id, contents: card.contents}))
